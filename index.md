...
comments to document code that would not get written out the that CSS file
...
file—with preprocessor comments, whereas our CSS—code which will not get
compiled into our CSS file—is documented using CSS comments. This means that we
have only the correct and relevant information available to us when debugging
our compiled stylesheets.
